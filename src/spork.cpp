// Copyright (c) 2015 The SCORE developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT) r = SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT_DEFAULT;
        ...
        if(nSporkID == SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT) r = SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT_DEFAULT;
        if(nSporkID == SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT) r = SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT_DEFAULT;
...
{
    if(strName == "SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT") return SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT;
    ...
    if(strName == "SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT") return SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT;
    if(strName == "SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT") return SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT;
...
{
    if(id == SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT) return "SPORK_1_MASTERNODE_PAYMENTS_ENSCOREMENT";
    ...
    if(id == SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT) return "SPORK_8_MASTERNODE_PAYMENT_ENSCOREMENT";
    if(id == SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT) return "SPORK_9_MASTERNODE_BUDGET_ENSCOREMENT";
