...
int nAnonymizeScoreAmount = 1000;
int nLiquidityProvider = 0;
/** Spork enscorement enabled time */
int64_t enscoreMasternodePaymentsTime = 4085657524;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Score
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Score
    // Mac: ~/Library/Application Support/Score
    // Unix: ~/.Score
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Score";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Score.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Scored.pid"));
