...
#define START_MASTERNODE_PAYMENTS_TESTNET 1514031852 //

#define START_MASTERNODE_PAYMENTS 1514031852 //
...
static const int64_t MAX_MONEY = 58800000 * COIN; 
...
void ResendWalletTransactions(bool fScore = false);
...
protected:
    ...
    virtual void ResendWalletTransactions(bool fScore) =0;
