...
#if defined(NDEBUG)
# error "Scorecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xe327e729656feaeb86616e3261b1d8535f1c1587d0a24a378d9f2fc723aad85b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Scorecoin: starting difficulty is 1 / 2^12
...
static const int64 nDiffChangeTarget = 65800; // Patch effective @ block 65710
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 99000 blocks
    nSubsidy >>= (nHeight / 99000);
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Scorecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1487872209, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Today is the 23th  scorecoin is here";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f75070283aabe27c93d0fae3a8e428eceb8e2d6ddbc79b2b5afdaba660e1d19d12740a1b5daf584d1e96919ba671342323db6ea52b9ef461e195a370c9d005f5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1487872209;
        ...
        assert(block.hashMerkleRoot == uint256("0xe937486d98090beddca87c1aa34979a9455a848af4c8c080dd2b8bccc0caa58b"));
...
unsigned char pchMessageStart[4] = { 0x83, 0xff, 0x51, 0x8b }; // Scorecoin: increase each by adding 2 to bitcoin's value.
