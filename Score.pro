...
windows:LIBS += -lws2_32 -lole32 -loleaut32 -luuid -lgdi32 -pthread
...
#SECP256K1_INCLUDE_PATH = $$PWD/src/secp256k1
}
...
macx:ICON = src/qt/res/icons/Score.icns
macx:TARGET = "Score-Qt"
